...
void main() {
  group('Brand.weekAccentFor mirrors the original weekNumber==1?red:blue rule', () {
    ...
    test('red and blue are always distinct (both themes)', () {
      expect(Brand.weekAccentFor(1, dark: false) ==
          Brand.weekAccentFor(2, dark: false), isFalse);
      expect(Brand.weekAccentFor(1, dark: true) ==
          Brand.weekAccentFor(2, dark: true), isFalse);
    });
  });
}
